...
class Chain:
    ...
    def insert_head(self, value):
        ...
        # affected.
            ...
            new_link.next = self.head # Connect new node to the previous head
            self.head.prev = new_link # Connect the previous head to the new node
            self.head = new_link      # Update the head to point to the new node
    ...
    def find_duplicates(self):
        ...
        while current is not None:
            dup_current = self.head
            while current is not None:
                if current == dup_current:
                    counter += 1
            if counter > 1:
